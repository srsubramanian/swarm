...
const code = `# SwarmOps orchestrator — LangGraph
...
const tabs = [
  { name: 'orchestrator.py', isActive: true },
  { name: 'state.py', isActive: false },
]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-linear-to-r from-indigo-200 via-sky-400 to-indigo-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                Multi-agent AI for fintech ops.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Three domain agents analyze every business event in parallel.
                A moderator synthesizes their output into actionable
